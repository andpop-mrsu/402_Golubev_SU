...
Игры в "Крестики-нолики" с компьютером на поле произвольного размера (от 3x3 до 10x10).
...
3. Выполнить команду `composer require SemkaHub/tic-tac-toe`;
...
Packagist: <https://packagist.org/packages/semyon/tic-tac-toe>
